...
<head>
	...
	<title>Laravel: Sebuah WEB Berbasis laravel</title>
...
<body>
	<div class="wrapper">
		<header>
			<h1>WEB Fathoni</h1>
			<h2>Sebuah WEB Berbasis laravel</h2>
		...
		<div role="main" class="main">
			<div class="home">
				...
				-->
				<h2>Silahkan Inputkan Nama dan Password Anda :</h2>
				<table border = 0>
				...
				<tr>
					<td></td>
					<td></td>
					<td><input type = "button" id = "reset" value = "Simpan"><input type = "reset" id = "reset" value = "Reset"></td>
				</tr>
